"""Taskset 3 runner for the photo-z data challenge.

Executes estimation-only and training+estimation pipelines for taskset 3
...
def run_taskset_3(
    public_area: str,
    submission: str,
    run_taskset_3_estimation_only: Callable[[str, str, str], None] | None,
    run_taskset_3_training_and_estimation: Callable[[str, str, str], None] | None,
) -> None:
    """Run taskset 3 evaluation for a submission.
