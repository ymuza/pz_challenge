...
def run_taskset_2(
    public_area: str,
    submission: str,
    run_taskset_2_estimation_only: Callable[[str, str, str], None] | None,
    run_taskset_2_training_and_estimation: Callable[[str, str, str], None] | None,
) -> None:
    """Run taskset 2 evaluation for a submission.
