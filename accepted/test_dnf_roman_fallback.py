...
SUBMISSION_NAME: str = "dnf_roman_fallback"
SUBMISSION_URL = "https://github.com/jdevicente/pz_data_challenge/releases/download/dnf-roman-fallback-v1/anf_lsst_roman_fallback_submission_submission.tgz"
...
def run_taskset_1_training_and_estimation(train_file, test_file, output_file) -> None:
    _dnf_fallback_train_and_estimate(train_file, test_file, output_file, mode="anf", use_roman=True)
